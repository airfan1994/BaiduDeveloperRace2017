...
class MessageInputStyle extends Style {
    ...
    static MessageInputStyle parse(Context context, AttributeSet attrs) {
        ...
        style.showSwithButton = typedArray.getBoolean(R.styleable.MessageInput_showSwithButton, false);
        style.swithButtonIcon = typedArray.getResourceId(R.styleable.MessageInput_swithButtonIcon, -1);
        style.swithButtonDefaultIconColor = typedArray.getColor(R.styleable.MessageInput_swithButtonDefaultIconColor,
                style.getColor(R.color.transparent));
        style.swithButtonDefaultIconPressedColor =
                typedArray.getColor(R.styleable.MessageInput_swithButtonDefaultIconPressedColor,
                        style.getColor(R.color.transparent));
        style.swithButtonDefaultIconDisabledColor =
                typedArray.getColor(R.styleable.MessageInput_swithButtonDefaultIconDisabledColor,
                        style.getColor(R.color.transparent));

        style.voiceButtonBackground = typedArray.getResourceId(R.styleable.MessageInput_voiceInputBackground, -1);

        style.swithButtonBackground = typedArray.getResourceId(R.styleable.MessageInput_swithButtonBackground, -1);
        style.swithButtonDefaultBgColor = typedArray.getColor(R.styleable.MessageInput_swithButtonDefaultBgColor,
                style.getColor(R.color.white_four));
        style.swithButtonDefaultBgPressedColor = typedArray.getColor(R.styleable
                        .MessageInput_swithButtonDefaultBgPressedColor,
                style.getColor(R.color.white_five));
        style.swithButtonDefaultBgDisabledColor = typedArray.getColor(R.styleable
                        .MessageInput_swithButtonDefaultBgDisabledColor,
                style.getColor(R.color.transparent));

        style.swithButtonWidth = typedArray.getDimensionPixelSize(R.styleable.MessageInput_swithButtonWidth, style
                .getDimension(R.dimen.input_button_width));
        style.swithButtonHeight = typedArray.getDimensionPixelSize(R.styleable.MessageInput_swithButtonHeight,
                style.getDimension(R.dimen.input_button_height));
        style.swithButtonMargin = typedArray.getDimensionPixelSize(R.styleable.MessageInput_swithButtonMargin,
        ...
        style.attachmentButtonDefaultBgColor =
                typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultBgColor,
                        style.getColor(R.color.white_four));
        style.attachmentButtonDefaultBgPressedColor =
                typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultBgPressedColor,
                        style.getColor(R.color.white_five));
        style.attachmentButtonDefaultBgDisabledColor =
                typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultBgDisabledColor,
                        style.getColor(R.color.transparent));
        ...
        style.attachmentButtonDefaultIconColor =
                typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultIconColor,
                        style.getColor(R.color.cornflower_blue_two));
        style.attachmentButtonDefaultIconPressedColor =
                typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultIconPressedColor,
                        style.getColor(R.color.cornflower_blue_two_dark));
        style.attachmentButtonDefaultIconDisabledColor =
                typedArray.getColor(R.styleable.MessageInput_attachmentButtonDefaultIconDisabledColor,
                        style.getColor(R.color.cornflower_blue_light_40));

        style.attachmentButtonWidth = typedArray.getDimensionPixelSize(R.styleable.MessageInput_attachmentButtonWidth,
                style.getDimension(R.dimen.input_button_width));
        style.attachmentButtonHeight = typedArray.getDimensionPixelSize(R.styleable.MessageInput_attachmentButtonHeight,
                style.getDimension(R.dimen.input_button_height));
        style.attachmentButtonMargin = typedArray.getDimensionPixelSize(R.styleable.MessageInput_attachmentButtonMargin,
                style.getDimension(R.dimen.input_button_margin));
        ...
        style.inputButtonDefaultBgPressedColor =
                typedArray.getColor(R.styleable.MessageInput_inputButtonDefaultBgPressedColor,
                        style.getColor(R.color.cornflower_blue_two_dark));
        style.inputButtonDefaultBgDisabledColor =
                typedArray.getColor(R.styleable.MessageInput_inputButtonDefaultBgDisabledColor,
                        style.getColor(R.color.white_four));
        ...
        style.inputButtonDefaultIconPressedColor =
                typedArray.getColor(R.styleable.MessageInput_inputButtonDefaultIconPressedColor,
                        style.getColor(R.color.warm_grey));
        style.inputButtonDefaultIconDisabledColor =
                typedArray.getColor(R.styleable.MessageInput_inputButtonDefaultIconDisabledColor,
                        style.getColor(R.color.warm_grey));
        ...
        style.inputTextColor =
                typedArray.getColor(R.styleable.MessageInput_inputTextColor, style.getColor(R.color.dark_grey_two));
        style.inputHintColor =
                typedArray.getColor(R.styleable.MessageInput_inputHintColor, style.getColor(R.color.warm_grey_three));
    ...
    private Drawable getSelector(@ColorInt int normalColor, @ColorInt int pressedColor,
        ...
        DrawableCompat.setTintList(drawable, new ColorStateList(states,
                new int[] {normalColor, pressedColor, disabledColor}));
        return drawable;
    }

    protected boolean showSwithButton() {
        return showSwithButton;
    }
    ...
    protected Drawable getVoiceButtonBackground() {
        return getDrawable(voiceButtonBackground);
    }

    protected Drawable getSwithButtonBackground() {
        if (swithButtonBackground == -1) {
            return getSelector(swithButtonDefaultBgColor, swithButtonDefaultBgPressedColor,
                    swithButtonDefaultBgDisabledColor, R.drawable.mask);
        } else {
            return getDrawable(swithButtonBackground);
        }
    }
    ...
    protected Drawable getSwithButtonIcon() {
        if (swithButtonIcon == -1) {
            return getSelector(swithButtonDefaultIconColor, swithButtonDefaultIconPressedColor,
                    swithButtonDefaultIconDisabledColor, R.drawable.chat_btn_input_keyboard);
        } else {
            return getDrawable(swithButtonIcon);
        }
    }

    protected int getSwithButtonWidth() {
        return swithButtonWidth;
    }

    protected int getSwithButtonHeight() {
        return swithButtonHeight;
    }

    protected int getSwithButtonMargin() {
        return swithButtonMargin;
    }

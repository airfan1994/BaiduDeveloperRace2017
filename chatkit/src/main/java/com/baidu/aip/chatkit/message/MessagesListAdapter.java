...
public class MessagesListAdapter<MESSAGE extends IMessage>
    ...
    private OnHintClickListener<MESSAGE> onHintClickListener;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holders.bind(holder, wrapper.item, wrapper.isSelected, imageLoader,
                ...
                viewClickListenersArray, onHintClickListener);
    }
    ...
    /**
     * Copies text to device clipboard and returns selected messages text. Also it does {@link #unselectAllItems()}
     * for you.
     *
    ...
    public void setOnHintClickListener(OnHintClickListener<MESSAGE> onHintClickListener) {
    ...
    public interface OnHintClickListener<MESSAGE extends IMessage> {

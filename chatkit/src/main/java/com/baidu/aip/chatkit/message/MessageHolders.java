...
public class MessageHolders {
    ...
    protected void bind(final ViewHolder holder, final Object item, boolean isSelected,
        ...
        if (item instanceof IMessage) {
            ...
            if (holder instanceof IncomingTextMessageViewHolder ) {
                ...
                incomingTextMessageViewHolder.setOnHintClickListener(onHintClickListener);
    ...
    public static class IncomingTextMessageViewHolder<MESSAGE extends IMessage>
        ...
        public IncomingTextMessageViewHolder(View itemView) {
            ...
            hint3 = (TextView) itemView.findViewById(R.id.hint0_tv);
        ...
        public void onBind(MESSAGE message) {
            ...
            List<String> hintList = message.getHintList();
            if (hintList.size() == 3) {
                hint1.setEnabled(true);
                hint1.setVisibility(View.VISIBLE);
                hint1.setText(hintList.get(0));
                hint2.setEnabled(true);
                hint2.setVisibility(View.VISIBLE);
                hint2.setText(hintList.get(1));
                hint3.setEnabled(true);
                hint3.setVisibility(View.VISIBLE);
                hint3.setText(hintList.get(2));
            } else if (hintList.size() == 2) {
                hint1.setEnabled(true);
                hint1.setVisibility(View.VISIBLE);
                hint1.setText(hintList.get(0));
                hint2.setEnabled(true);
